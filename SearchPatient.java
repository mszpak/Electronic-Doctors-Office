...
public class SearchPatient extends JFrame implements ActionListener{
	...
	public SearchPatient(String name)
	{
		super(name);
		
		lblPatientID = new JLabel("Patient ID");
		patientID = new JTextField();
		butSearch = new JButton("Search Patient");
	...
	public static void main(String[] args) {
		SearchPatient g = new SearchPatient("Search Patient");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == butSearch)
		{
			...
			if(d.searchPatient(id) != null)
			{
				patient p = d.searchPatient(id);
			...
			{
				JFrame f1 = new JFrame("Did not find patient");
				f1.setSize(200,75);
				f1.setVisible(true);
				JLabel lbl = new JLabel("Patient Could Not Be Found");
				JPanel pan = new JPanel();
				f1.add(pan);
				pan.add(lbl);
			}
